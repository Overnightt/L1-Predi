...
#A list of all teams
all_team_names = ['Le Havre', 'Paris SG', 'Brest', 'Marseille', 'Reims', 'Lille', 'Monaco', 'St Etienne', 'Auxerre', 'Nice', 'Angers', 'Lens', 'Montpellier', 'Strasbourg', 'Toulouse', 'Rennes', 'Lyon','Nantes','Paris FC', 'Metz','Lorient','Clermont','Troyes','Ajaccio']
